...
const appConfig = {
  appName: withFallback(import.meta.env.VITE_APP_NAME, 'NovaChat'),
  ...
  welcomeMessage: withFallback(
    ...
    'Welcome to NovaChat! Ask anything to get started.'
  ),
  historyTitle: withFallback(import.meta.env.VITE_SIDEBAR_TITLE, 'Conversations'),
  theme: {
